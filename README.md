...
- [Public API For Consumers](#public-api-for-consumers)
  ...
  - [`snapshot = db.snapshot()`](#snapshot--dbsnapshot)
  ...
  - [`snapshot`](#snapshot)
    - [`snapshot.close([callback])`](#snapshotclosecallback)
  ...
  - [Errors](#errors)
    ...
    - [`LEVEL_SNAPSHOT_NOT_OPEN`](#level_snapshot_not_open)
  ...
  - [Reading From Snapshots](#reading-from-snapshots)
    - [1. Implementation does not support snapshots](#1-implementation-does-not-support-snapshots)
    - [2. Implementation supports implicit snapshots](#2-implementation-supports-implicit-snapshots)
    - [3. Implementation supports explicit snapshots](#3-implementation-supports-explicit-snapshots)
...
- [Private API For Implementors](#private-api-for-implementors)
  ...
  - [`snapshot = db._snapshot()`](#snapshot--db_snapshot)
  ...
  - [`snapshot = AbstractSnapshot(db)`](#snapshot--abstractsnapshotdb)
    - [`snapshot._close(callback)`](#snapshot_closecallback)
...
Other read operations like `db.get()` also use a snapshot. Such a method call should<sup>1</sup> synchronously create a snapshot and then read from it. This means a write operation (to the same key) may not be visible unless awaited:
